 ...
 */
 ...
 class VocabulariosIA{
     public:
     virtual Resultado Executar(ResultadoUsuario&) throw (invalid_argument) = 0;
     /**
 ...
 class VocabulariosIS{
     public:
          ...
          * @brief ConsultarVocabulario() é uma funcao que imprime o conteudo de vocabulario, ou seja, Data e Idioma.
           ...
           * @return void
           */
          virtual void ConsultaDefinicaoTermo(const vector<Definicao>&) throw(invalid_argument) = 0;
       ...
       * @return Resultado, retorna se foi sucesso ou falha.
       */
      virtual Resultado EditarTermo(Termo &termo) throw(invalid_argument) = 0;
      /**
       * @brief EditarDefinicaoTermo() é uma funcao que edita a definicao do Termo passado.
       * @param const Termo&
       * @return Resultado, retorna se foi sucesso ou falha.
       */
      virtual Resultado EditarDefinicaoTermo(string Texto_Definicao_anterior) throw(invalid_argument) = 0;
       ...
       * @return Resultado, retorna se foi sucesso ou falha.
       */
     virtual Resultado CriaVocabulario(const ResultadoUsuario&) throw(invalid_argument) = 0;
      /**
